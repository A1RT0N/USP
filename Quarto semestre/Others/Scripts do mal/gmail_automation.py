...
your_first_name = "Ayrton"
your_last_name = "filho"
...
def fill_form(driver):
    try:
       ...
       # Create custom email
        ...
        # Salvar as credenciais no CSV
        save_to_csv(f"{your_username}@gmail.com", your_password)
