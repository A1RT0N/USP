...
public class ArvBal extends ArvBin{
    ...
    private void remotar_arvore_aux(int inicio, int fim, ArrayList<String> tree){
        if(inicio > fim){  
            return;
        }
    ...
    protected boolean remove_aux(String v){
        ...
        ArrayList<String> bfs = super.bfs(index, true); 
