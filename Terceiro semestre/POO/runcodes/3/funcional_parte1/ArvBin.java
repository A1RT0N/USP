...
public class ArvBin{
    ...
    protected ArvBin(int len){
        this.abb = new String[len]; // criar a árvore (todos os valores nulos)

        this.tamanho = tamanho;
    }

    //-----------------Funções auxiliares-----------------
    protected int nodeRight(int index){ //retorna o index do filho direito
        // if (index >= (this.tamanho)){
        //     return -1; //erro
        // }

        int index_filho = (2 * index) + 2;

        // if (index_filho >= (this.tamanho)){
        //     return -1; //erro
        // }
    ...
    protected int nodeLeft(int index){ //retorna o index do filho esquerdo
        // if (index >= (this.tamanho - 1)){
        //     return -1; //erro
        // }

        int index_filho = (2 * index) + 1;

        // if (index_filho >= (this.tamanho - 1)){
        //     return -1; //erro
        // }
    ...
    protected void setNode(int i, String v){ //mudar o valor de um index para um valor específico
        // if (i >= (this.tamanho - 1)){
        //     return; //erro
        // }
    ...
    protected String getNode(int i){ //pega o valor dado um index
        // if (i >= (this.tamanho - 1)){
        //     return null;
        // }
        
        return this.abb[i]; //se for nulo vai retonar nulo tb
    }

    protected int countNodes(int i){ //conta a quantidade de nós que tem a partir de um index fornecido
        if (i == -1) return 0;

        if (this.abb[i] == null) return 0;

        return 1 + countNodes(this.nodeLeft(i)) + countNodes(this.nodeRight(i));
    }
