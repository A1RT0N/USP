...
void opcao_1(){
    char arquivo_entrada[1000]; //string para arquivo de entrada
    char arquivo_saida[1000]; //string para arquivo de saida
...
void opcao_2(){
    char arquivo_entrada[1000]; //string para arquivo de etnrada
...
void opcao_4(){
    char arquivo_dados[1000];
    char arquivo_indices[1000];
    ...
    CreateIndex(arqDados, arqIndices); //cria o índice
...
void opcao_5(){
    ...
    remove_registro(arquivo_dados, arquivo_indices, n); //chamar a funcionalidade 5
}
...
void opcao_6(){
    ...
    inserir(arquivo_dados, arquivo_indices, n); //chamar a funcionalidade 6
}
